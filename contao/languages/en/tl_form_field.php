...
// Reference
$GLOBALS['TL_LANG']['tl_form_field']['cloudflare_turnstile_size_ref'] = [
    'normal' => 'Normal',
    'flexible' => 'Flexible',
    'compact' => 'Compact',
];

$GLOBALS['TL_LANG']['tl_form_field']['cloudflare_turnstile_theme_ref'] = [
    'auto' => 'Auto',
    'light' => 'Light',
    'dark' => 'Dark',
];

$GLOBALS['TL_LANG']['tl_form_field']['cloudflare_turnstile_appearance_ref'] = [
    'always' => 'Always',
    'execute' => 'Execute',
